...
class ProductView {
    ...
    getProductBySubcategory(args, cb) {
        const data = {
            product: []
        };
        let per_page = args.perPage || 10;
    ...
    getProductReport(args, cb) {
        ...
        GROUP BY productid 
        ) AS productorder`), "product.id", "productorder.productid")
