...
class CompanyInfoRouter extends express_application_1.ExpressRouter {
    constructor() {
        super();
        this.route("/company-info").all(permission_1.Permission.onLoad).get(this.getEdit).post(this.postEdit);
    }
    onLoad(req, res, next) {
    ...
    getEdit(req, res, next) {
        ...
        let params = { title: config_json_1.default.appname, user: req.user.username, postUrl: postUrl, listUrl: "/company-info" };
...
exports.default = new CompanyInfoRouter();
