...
class OrderRouter extends express_application_1.ExpressRouter {
    constructor() {
        super();
        this.route("/order-rejected").all(permission_1.Permission.onLoad).get(this.getList);
        this.route("/order-rejected/details/:id").all(permission_1.Permission.onLoad).get(this.getDetail);
    }
    onLoad(req, res, next) {
    ...
    getList(req, res, next) {
        let params = { title: config_json_1.default.appname, user: req.user.username, postUrl: "/order-rejected", params: {} };
    ...
    getDetail(req, res, next) {
        ...
        let params = { title: config_json_1.default.appname, postUrl: postUrl, listUrl: "/order-rejected", params: data };
        params = permission_1.Permission.getMenuParams(params, req, res);
        RestApi.getDb("order")
...
//# sourceMappingURL=order-rejected.js.map