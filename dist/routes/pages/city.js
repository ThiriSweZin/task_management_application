...
class CityRouter extends express_application_1.ExpressRouter {
    constructor() {
        super();
        this.route("/city").all(permission_1.Permission.onLoad).get(this.getList);
        this.route("/city/entry").all(permission_1.Permission.onLoad).get(this.getEntry).post(this.postEntry);
        this.route("/city/edit/:id").all(permission_1.Permission.onLoad).get(this.getEdit).post(this.postEdit);
        this.route("/city/delete/:id").all(permission_1.Permission.onLoad).post(this.postDelete);
    }
    onLoad(req, res, next) {
    ...
    getEntry(req, res, next) {
        let params = { title: config_json_1.default.appname, user: req.user.username, postUrl: "/city/entry", params: {}, listUrl: "/city" };
    ...
    getEdit(req, res, next) {
        ...
        let params = { title: config_json_1.default.appname, user: req.user.username, postUrl: postUrl, listUrl: "/city", params: data };
        params = permission_1.Permission.getMenuParams(params, req, res);
        RestApi.getDb("city")
