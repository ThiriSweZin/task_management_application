...
class Utils {
    ...
    static tryGet(obj, key, defVal = {}) {
        if (!obj || typeof obj != "object")
            return defVal;
        if ((!key && key != 0) || typeof key == "undefined")
            return defVal;
    ...
    static toSqlDateWithM(dateVal, fromFormat = "DD/MMM/YYYY") {
        if (!dateVal)
            return "";
        let dateObj = new Date();
        if (typeof dateVal === "string") {
    ...
    static toSqlDateMMMM(dateVal, fromFormat = "D/MMMM/YYYY") {
        if (!dateVal) {
            return "";
        }
        let dateObj = new Date();
    ...
    static toSqlDateDDMMYYYY(dateVal, fromFormat = "DD-MM-YYYY") {
        if (!dateVal) {
            return "";
        }
        let dateObj = new Date();
    ...
    static toSqlDateTime(dateVal, fromFormat = "DD/MM/YYYY") {
        if (!dateVal) {
            return "";
        }
        let dateObj = new Date();
    ...
    static toSqlTime(dateVal, fromFormat = "HH:mm") {
        if (!dateVal) {
            return "";
        }
        let dateObj;
    ...
    static toDateCode(dateVal, fromFormat = "DD/MM/YYYY") {
        if (!dateVal) {
            return "";
        }
        let dateObj = new Date();
    ...
    static toDisplayDateTime(dateVal, fromFormat = "YYYY-MM-DD HH:mm") {
        if (!dateVal) {
            return "";
        }
        let dateObj = new Date();
