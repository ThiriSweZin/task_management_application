...
class MMCalendar {
    ...
    getMyConst(my) {
        ...
        if (i >= 0)
            res.WO += fme[i][1]; // full moon day offset exceptions
        i = bSearch1(my, wte);
        if (i >= 0)
            res.EW = 1; // correct watat exceptions
        return res;
    }
    /**
...
exports.MMCalendar = MMCalendar;
//# sourceMappingURL=mm-calendar.js.map