...
(function($, window, document, undefined) {
  ...
  var _pager = function(context) {
    ...
    this.container = $('<ul>', { "class": "pagination" });
  ...
  _pager.prototype = {
    ...
    _appendButton: function(parent, index, opts) {
      ...
      var btn = $('<a>', $.extend(true, {}, {
        'href': '#',
        'data-page': index
      }, opts.attrs || {})).html(text);
      $('<li>', { "class": cssClass + (opts.active ? " active disabled" : "") + (opts.disabled ? " disabled" : "") })
