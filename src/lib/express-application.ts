...
export abstract class ExpressApplication {
   ...
   */
  public set(setting: string, val: any): core.Application {
   ...
   */
  public engine(ext: string, fn: (path: string, options: object, callback: (e: any, rendered: string) => void) => void): core.Application {
